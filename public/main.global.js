(function () {
  ...
  function mount() {
    ...
    root.innerHTML = mascot() + '\n' +
      ...
      '  <section class="home-forms stagger-in"><div class="home-forms-heading"><p class="partnerships-kicker"><span class="kicker-dot"></span> Get involved</p><h2>Help shape AITutor.</h2></div><div class="home-forms-grid"><a class="home-form-card" href="/forms"><span class="home-form-icon">🐛</span><strong>Report a bug</strong><p>Something broken? Our AI triages your report instantly.</p></a><a class="home-form-card" href="/forms"><span class="home-form-icon">🚩</span><strong>Report a member</strong><p>See rule-breaking in the community? Tell the mod team.</p></a><a class="home-form-card" href="/forms"><span class="home-form-icon">🛡️</span><strong>Become a Mod or Admin</strong><p>Apply with your free account — an AI reviewer emails you the result.</p></a></div></section>\n' +
